...
export default function ForgetSenseCardPage() {
    ...
    const fetchData = async () => {
        try {
            ...
            if (!co && !department) {
                if (!ForgetSenseCard || ForgetSenseCard.length === 0) { // Chỉ log nếu chưa có dữ liệu trước đó
                ...
                const { payload } = await ForgetSenseCardApiRequest.getList(queryParams);
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <div className="space-y-1">
                                <ForgetSenseCardTable
                                    ForgetSenseCard={ForgetSenseCard}
