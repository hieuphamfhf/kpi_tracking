...
import { GraduationCapIcon,IdCardIcon,ClockAlertIcon ,BellRingIcon, CircleHelpIcon, CalendarClock, ChartNoAxesCombined,CircleUser,BookUser,Plane,TicketsPlane   } from "lucide-react";
// Update your links with corresponding icons
// import { KPIIcon} from '../../components/ui/icons';
// import { KPIIcon, DetailTravelIcon, DayTravelIcon, PlaneTravelIcon } from "../../components/ui/icons";
...
export const links = [
  ...
  { id: 7, name: '探親單查詢畫面', href: `http://localhost:3000/FamilyVisit`, icon: TicketsPlane  , onlyManager: true }, // Time-related icon
  { id: 8, name: '探親單查詢(依據日期)', href: `http://localhost:3000/ManagerReturnStatus`, icon: Plane , onlyManager: true }, // Time-related icon
  { id: 9, name: '探親單詳細內容查詢(日曆)', href: `http://localhost:3000/ReturnTaiwanPeriodDetails`, icon: BookUser  , onlyManager: true }, // Time-related icon
