...
import { GraduationCapIcon,IdCardIcon,ClockAlertIcon ,BellRingIcon, CircleHelpIcon, CalendarClock, ChartNoAxesCombined} from "lucide-react";
...
export const links = [
  ...
  { id: 7, name: '8_探親單查詢畫面', href: `http://localhost:3000/FamilyVisit`, icon: ClockAlertIcon  }, // Time-related icon
  
  {id: 8, name: '6_每月各部人事KPI統計表', href: `http://localhost:3000/MonthlyKPI`, icon: ChartNoAxesCombined  }, // Time-related icon
];
