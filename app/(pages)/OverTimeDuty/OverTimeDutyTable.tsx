...
export default function OverTimeDutyTable({ OverTimeDuty, onStartDate, onEndDate, onDepartment, onCompany, company }: {
                    ...
                    <Table className="table-auto whitespace-nowrap">
                        <TableHeader className="custom-table-header">
                            <TableRow>
                                ...
                                <TableHead className="w-40">姓名</TableHead>
                                <TableHead className="w-40">是否事前派工</TableHead>
                                <TableHead className="w-56">是否事前填单</TableHead>
